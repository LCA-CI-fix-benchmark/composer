...
def check_hf_tokenizer_equivalence(tokenizer1, tokenizer2):
    ...
    tokenizer1_auto_map = tokenizer1.__dict__['init_kwargs'].get('auto_map', {})
    if tokenizer1_auto_map:
        tokenizer1_name = tokenizer1_auto_map.get('name', '')get('AutoTokenizer', [None])[0]
