...
Algorithms, such a                These indices may not correspond to the order in which modules get called in the forward pass.
        ...
        optimizers (torch.optim.Optimizer | Sequence[torch.optim.Optimizer], optional): One or more.lass:`~composer.algorithms.blurpool.BlurPool`, replace model parameters in-place.
