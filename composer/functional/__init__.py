# Copyright 2from composer.algorithms.alibi import apply_alibi
...
cf.apply_squeeze_excite(model, latent_channels=64, min_channels=128)# SPDX-License-Identifier: Apache-2.0
